...
$form['form-1'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Заявка с формы "Не рискуйте"',
		'title' => 'Заявка с формы "Не рискуйте"',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'false',
		'from_name' => 'noreply',
		...
		'okay' => 'Сообщение отправлено. Мы скоро свяжемся с вами',
...
$form['form-2'] = array(
	'fields' => array(
		...
		'tell' => array(
			'title' => 'Телефон',
			'validate' => array(
				'preg' => "/^\+7{1}[(]{1}[0-9]{3}\)\s{1}[0-9]{3}[-]{1}[0-9]{4}$/",
				'minlength' => '5',
			),
			'messages' => array(
				'preg' => 'Поле [ %1$s ] возможно содержит ошибку',
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Заявка с формы "Закажи звонок"',
		'title' => 'Заявка с формы "Закажи звонок"',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'false',
		'from_name' => 'noreply',
